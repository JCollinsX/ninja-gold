...
var MRAID = {
	...
	processSettings: function(settings, values) {
		...
		if (window.location.hostname === 'mraid.io' || window.location.hostname === 'fatenation.info') Settings["loading-icon-publisher-styles"]["display"] = "none";
